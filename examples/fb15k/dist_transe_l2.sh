...
do
    ...
    --ip_config ./ip_config.txt --hidden_dim 400 --gamma 19.9 --lr 0.25 --total_client 64 --server_id $SERVER_ID_LOW &
    let SERVER_ID_LOW+=1
done
...
--ip_config ./ip_config.txt --batch_size 1000 --neg_sample_size 200 --hidden_dim 400 --gamma 19.9 --lr 0.25 --max_step 500 --log_interval 100 --num_thread 1 \
