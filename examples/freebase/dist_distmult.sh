...
do
    ...
    --ip_config ../ip_config.txt --hidden_dim 400 --gamma 143.0 --lr 0.08 --total_client 160 --server_id $SERVER_ID_LOW &
    let SERVER_ID_LOW+=1
done
...
--ip_config ../ip_config.txt --batch_size 1024 --neg_sample_size 256 --hidden_dim 400 --gamma 143.0 --lr 0.08 --max_step 12500 --log_interval 100 \
