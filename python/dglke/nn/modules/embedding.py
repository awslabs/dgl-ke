...
class ExternalEmbedding(Module):
    ...
    """
    def __init__(self, args, num, dim, device, embedding_name="external embedding"):
        super(ExternalEmbedding, self).__init__(embedding_name)
        self.gpu = args.gpu
        self.args = args
        self.num = num
        self.trace = []
